...
CLIENT_ID = "XS99684"  # Your Fyers Client ID
PIN = "6666"  # User pin for Fyers account
...
TOTP_SECRET_KEY = "OG27GYY7NNEBRMJEAFYBYUB76VT7SUCU"  # TOTP secret key, copy the secret while enabling TOTP.
